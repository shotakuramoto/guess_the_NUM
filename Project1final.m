...
targetrow = floor(randi(3));
targetcol = floor(randi(3));
...
while ~ playercorrect;
    ...
    elseif guessrow > 5 || guesscol > 5 || guessrow < 1 || guesscol < 1
        ...
        while ~ playercorrect2
            ...
            elseif guessrow2 > 5 || guesscol2 > 5 || guessrow2 < 1 || guesscol2 < 1
             ...
             %When the player made same guess from previous row
             
             %When the player made same 'row' and 'column' guess from the previous guess    
            ...
            %when the player got row correct    
            ...
            %When the player got 'row' and 'column' wrong    
            elseif abs(guessrow2 - targetrow) < abs(preguessrow - targetrow) && abs(guesscol2 - targetcol) < abs(preguesscol - targetcol)
    ...
    %End of the if statment of the first guess    
    end
